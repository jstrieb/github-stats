...
1. Create a personal access token (not the default GitHub Actions token) using
   ...
   Don't use the fine-grained tokens, instead use the classsic ones, as those
   are what these docs were created with in mind.
...
3. Create a copy of this repository by clicking
   [here](https://github.com/jstrieb/github-stats/generate). Note: this is
   **not** the same as forking a copy because it copies everything fresh,
   without the huge commit history. 
4. Go to the "Secrets" page of your copy of the repository. If this is the
